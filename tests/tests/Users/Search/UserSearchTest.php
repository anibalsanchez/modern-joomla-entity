...
namespace Extly\Joomla\Entity\Tests\Users\Search;

defined('_JEXEC') || die;

use Extly\Joomla\Entity\Users\Search\UserSearch;
...
class UserSearchTest extends \TestCaseDatabase
{
    ...
    public function blockedFilterIsApplied()
    {
        $statuses = array_unique(
            array_map(
                fn ($itemData) => (int) $itemData['block'],
                UserSearch::instance(
                    [
                        'filter.blocked' => 0,
                        'list.limit'   => 0,
    ...
    protected function getDataSet()
    {
        ...
        $phpUnitExtensionsDatabaseDataSetCsvDataSet->addTable('jos_users', __DIR__.'/Stubs/Database/users.csv');
        $phpUnitExtensionsDatabaseDataSetCsvDataSet->addTable('jos_user_usergroup_map', __DIR__.'/Stubs/Database/user_usergroup_map.csv');
